#ifndef PROMFGELEMTOOLMTNTHREADMILL_H
#define PROMFGELEMTOOLMTNTHREADMILL_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Thread Milling" (PRO_TM_TYPE_THREAD_MILLING). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_THREAD_MILLING
...
#endif /* PROMFGELEMTOOLMTNTHREADMILL_H */
