#ifndef PROMFGELEMTOOLMTNGROOVEMILL_H
#define PROMFGELEMTOOLMTNGROOVEMILL_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Groove Milling" (PRO_TM_TYPE_GROOVE_MILLING). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_GROOVE_MILLING
...
#endif /* PROMFGELEMTOOLMTNGROOVEMILL_H */
