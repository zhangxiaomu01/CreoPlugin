#ifndef PROMFGELEMTOOLMTNGROOVETURN_H
#define PROMFGELEMTOOLMTNGROOVETURN_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Groove Turning" (PRO_TM_TYPE_GROOVE_TURNING). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_GROOVE_TURNING
...
#endif /* PROMFGELEMTOOLMTNGROOVETURN_H */
