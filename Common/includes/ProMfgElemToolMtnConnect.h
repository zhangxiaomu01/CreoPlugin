#ifndef PROMFGELEMTOOLMTNCONNECT_H
#define PROMFGELEMTOOLMTNCONNECT_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Connect" (PRO_TM_TYPE_CONNECT). 
*/
...
PRO_E_TOOL_MTN_AXIS_MOVES  Axis Move Attributs   PRO_VALUE_TYPE_INT        Note-5
...
Note-3  : Tool motion type - PRO_TM_TYPE_CONNECT
...
#endif /* PROMFGELEMTOOLMTNCONNECT_H */
