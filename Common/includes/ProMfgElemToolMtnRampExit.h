#ifndef PROMFGELEMTOOLMTNRAMPEXIT_H
#define PROMFGELEMTOOLMTNRAMPEXIT_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Ramp Exit" (PRO_TM_TYPE_RAMP_EXIT). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_RAMP_EXIT
          Values defined by ProTmType. 
          Mandatory.

Note-4  : Array of manufacturing parameters.
          EXIT_ANGLE, TANGENT_LEAD_STEP, NORMAL_LEAD_STEP and LEAD_RADIUS 
          parameters are used to define Ramp Exit Motion.
...
#endif /* PROMFGELEMTOOLMTNRAMPEXIT_H */
