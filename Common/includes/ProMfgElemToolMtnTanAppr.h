#ifndef PROMFGELEMTOOLMTNTANAPPR_H
#define PROMFGELEMTOOLMTNTANAPPR_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Tangent Approach" (PRO_TM_TYPE_TANGENT_APPROACH). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_TANGENT_APPROACH
...
Note-9  : Axis selection. Optional for 5-axis nc sequences.
...
#endif /* PROMFGELEMTOOLMTNTANAPPR_H */
