#ifndef PROMFGFEATTHREADMILLING_H
#define PROMFGFEATTHREADMILLING_H
/*
   Creo Parametric TOOLKIT declarations related to mfg thread milling sequence.
*/
...
PRO_E_MFG_MILL_THREAD_TYPE_OPT  Thread Type          PRO_VALUE_TYPE_INT        Note-7 
PRO_E_MFG_MILL_THREAD_TAPER_OPT Taper Type           PRO_VALUE_TYPE_INT        Note-8
PRO_E_MFG_TOOL_REF_COMPOUND     Tool                 Compound                  Note-9 
PRO_E_MFG_TOOL_ADAPTER_NAME     Tool Attachment      PRO_VALUE_TYPE_WSTRING    Note-10
PRO_E_MFG_PARAM_SITE_NAME       Site Name            PRO_VALUE_TYPE_WSTRING    Note-11
PRO_E_MFG_PARAM_ARR             Mfg Parameter Array  Array                     Note-12
PRO_E_MFG_THRM_HOLESET_ARR      Thread Holeset Array Array                     Note-13
PRO_E_TOOL_MTN_ARR              Tool Motion Array    Array                     Note-14
PRO_E_TOOL_MTN                  Tool Motion          Compound                  Note-15
PRO_E_MFG_START_PNT             Start Point          PRO_VALUE_TYPE_SELECTION  Note-16
PRO_E_MFG_END_PNT               End Point            PRO_VALUE_TYPE_SELECTION  Note-17
...
Note-7  : Thread type - external/internal.
          Values defined by ProMillThreadType.
          Mandatory.

Note-8  : Taper type - None/NPT/Custom.
          Values defined by ProMillThreadTaperType.
          Mandatory.
...
Note-10  : Tool adapter model name.
          Optional.

Note-11 : Name of site with default values for manufacturing parameters.
          Name is going to be ignored if site doesn't exist in the mfg model.
          Optional.
         
Note-12 : Array of manufacturing parameters.
          Please see ProMfgElemParam.h.
          Mandatory.

Note-13 : Array of thread holesets - specification of threads to machine.
          Please see ProMfgElemThreadHoleset.h.
          Mandatory.

Note-14 : Array of tool motions.
          Mandatory

Note-15 : Tool motion compound specification. Mandatory

          Applicable tool motion types:
            PRO_TM_TYPE_THREAD_MILLING       (please see ProMfgElemToolMtnThreadMill.h)
...
Note-16 : Datum point selection. Allows to start machining at the specified 
          position.
          Optional.

Note-17 : Datum point selection. Allows to end machining at the specified 
          position.
          Optional.
...
#endif /* PROMFGFEATTHREADMILLING_H */
