#ifndef PROMFGFEATTRAJECTORY_H
#define PROMFGFEATTRAJECTORY_H
/*
   Creo Parametric TOOLKIT declarations related to mfg milling trajectory sequence.
*/
...
PRO_E_CHECK_SURF_COLL           Check Surfaces       PRO_VALUE_TYPE_SELECTION  Note-11
...
PRO_E_MFG_SEQ_NUM_AXES_OPT      Number of Axes       PRO_VALUE_TYPE_INT        Note-24
...
Note-3  : PRO_NCSEQ_TRAJ_MILL_STEP
          Mandatory.
...
Note-11 : Check surfaces compound definition.
...
Note-13 : Tool motion compound specification. Optional.

          Applicable tool motion types:
            PRO_TM_TYPE_CURVE_TRAJECTORY     (please see ProMfgElemToolMtnCrvTraj.h)
            PRO_TM_TYPE_SURF_TRAJECTORY      (please see ProMfgElemToolMtnSrfTraj.h)
          ...
          Follow Cut motion must be placed just after Curve/Surface Trajectory motions
...
Note-24 : 3, 4, or 5. Can be set to 5 only if work center allows 5-axis
          machining.
