#ifndef PROMFGELEMTOOLMTNNORMEXIT_H
#define PROMFGELEMTOOLMTNNORMEXIT_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Normal Exit" (PRO_TM_TYPE_NORMAL_EXIT). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_NORMAL_EXIT
...
#endif /* PROMFGELEMTOOLMTNNORMEXIT_H */
