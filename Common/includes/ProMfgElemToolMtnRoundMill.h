#ifndef PROMFGELEMTOOLMTNROUNDMIL_H
#define PROMFGELEMTOOLMTNROUNDMIL_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Round Milling" (PRO_TM_TYPE_ROUND_MILLING). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_ROUND_MILLING
...
#endif /* PROMFGELEMTOOLMTNROUNDMIL_H */
