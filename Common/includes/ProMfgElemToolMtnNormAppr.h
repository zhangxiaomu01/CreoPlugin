#ifndef PROMFGELEMTOOLMTNNORMAPPR_H
#define PROMFGELEMTOOLMTNNORMAPPR_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Normal Approach" (PRO_TM_TYPE_NORMAL_APPROACH). 
*/
...
PRO_E_MFG_APPR_EXIT_DIR    Appr/Exit Orientation PRO_VALUE_TYPE_INT        Note-9
PRO_E_TOOL_MTN_AXIS_REF    Axis Reference        PRO_VALUE_TYPE_SELECTION  Note-10        
PRO_E_TOOL_MTN_FEED_TYPE   Tool Motion Feed Type PRO_VALUE_TYPE_INT        Note-11
...
Note-3  : Tool motion type - PRO_TM_TYPE_NORMAL_APPROACH
          Values defined by ProTmType. 
          Mandatory.

Note-4  : Array of manufacturing parameters.
          APPROACH_DIST parameter specifies the approach distance.
...
Note-9  : PRO_TM_DIR_RIGHT_SIDE or PRO_TM_DIR_LEFT_SIDE.
          Values defined by ProTmSideDir. Please see ProMfgOptions.h
          Mandatory.
          
Note-10 : Axis selection. Optional for 5-axis nc sequences.
...
#endif /* PROMFGELEMTOOLMTNNORMAPPR_H */
