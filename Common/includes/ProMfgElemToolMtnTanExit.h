#ifndef PROMFGELEMTOOLMTNTANEXIT_H
#define PROMFGELEMTOOLMTNTANEXIT_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Tangent Exit" (PRO_TM_TYPE_TANGENT_EXIT). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_TANGENT_EXIT
          Values defined by ProTmType. 
          Mandatory.

Note-4  : Array of manufacturing parameters.
          EXIT_DISTANCE parameter specifies the exit distance.
...
#endif /* PROMFGELEMTOOLMTNTANEXIT_H */
