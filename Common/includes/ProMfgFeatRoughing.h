#ifndef PROMFGFEATROUGHING_H
#define PROMFGFEATROUGHING_H
/*
   Creo Parametric TOOLKIT declarations related to mfg milling roughing sequence.
*/
...
Note-3  : PRO_NCSEQ_ROUGHVOL_MILL
          Mandatory.
