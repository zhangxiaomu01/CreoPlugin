#ifndef PROMFGELEMTOOLMTNGORETR_H
#define PROMFGELEMTOOLMTNGORETR_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Retract" (PRO_TM_TYPE_GO_RETRACT). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_GO_RETRACT
...
#endif /* PROMFGELEMTOOLMTNGORETR_H */
