#ifndef PROMFGELEMTOOLMTNAUTOCUT_H
#define PROMFGELEMTOOLMTNAUTOCUT_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Automatic Cut" (PRO_TM_TYPE_AUTOMATIC_CUT). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_AUTOMATIC_CUT
...
#endif /* PROMFGELEMTOOLMTNAUTOCUT_H */
