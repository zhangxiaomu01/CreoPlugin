#ifndef PROMFGFEATROUNDCHAMFERMILL_H
#define PROMFGFEATROUNDCHAMFERMILL_H
/*
   Creo Parametric TOOLKIT declarations related to mfg round and chamfer 
   milling sequences.
*/
...
PRO_E_CHECK_SURF_COLL           Check Surfaces       PRO_VALUE_TYPE_SELECTION  Note-13
...
PRO_E_MFG_CUT_START_PNT_REF     Start Point Ref      PRO_VALUE_TYPE_SELECTION  Note-26
PRO_E_MFG_SUB_SPINDLE_OPT       Sub-spindle Option   PRO_VALUE_TYPE_INT        Note-27
...
Note-3  : PRO_NCSEQ_ROUND_MILL   - for round sequence.
          PRO_NCSEQ_CHAMFER_MILL - for chamfer sequence.
          Mandatory.
...
Note-13 : Check surfaces compound definition.
...
Note-15 : Tool motion compound specification. Optional.

          Applicable tool motion types:
	    PRO_TM_TYPE_ROUND_MILLING        for round sequence 
                                                   (please see ProMfgElemToolMtnRoundMill.h)
	    PRO_TM_TYPE_CHAMFER_MILLING      for chamfer sequence 
                                                   (please see ProMfgElemToolMtnChamferMill.h)
...
Note-26 : Selection of a datum point, or a point on the bottom edgest of 
...
Note-27 : Type of spindle assigned to the sequence.
...
#endif /* PROMFGFEATROUNDCHAMFERMILL_H */
