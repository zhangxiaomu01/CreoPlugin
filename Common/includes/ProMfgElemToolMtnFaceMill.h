#ifndef PROMFGELEMTOOLMTNFACEMILL_H
#define PROMFGELEMTOOLMTNFACEMILL_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Face Milling" (PRO_TM_TYPE_FACE_MILLING). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_FACE_MILLING.
          Mandatory.
...
#endif /* PROMFGELEMTOOLMTNFACEMILL_H */
