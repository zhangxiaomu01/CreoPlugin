#ifndef PROMFGELEMTOOLMTNCUTLINEMIL_H
#define PROMFGELEMTOOLMTNCUTLINEMIL_H
/*
  Creo Parametric TOOLKIT declarations related to specification of tool motion
  of type "Cutline Milling" (PRO_TM_TYPE_CUTLINE_MILLING). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_CUTLINE_MILLING
...
#endif /* PROMFGELEMTOOLMTNCUTLINEMIL_H */
