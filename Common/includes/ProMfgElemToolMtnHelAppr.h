...
/*
  ...
  of type "Helical Approach" (PRO_TM_TYPE_HELICAL_APPROACH). 
*/
...
Note-3  : Tool motion type - PRO_TM_TYPE_HELICAL_APPROACH
          Values defined by ProTmType. 
          Mandatory.

Note-4  : Array of manufacturing parameters.
          ENTRY_ANGLE, CLEAR_DIST, NORMAL_LEAD_STEP and LEAD_RADIUS 
